...
const Footer = () => (
  <section lassName={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      ...
      justify-between flex-wrap md:mt-0 mt-10">
       {footerLinks.map((footerLink)=>(
          ...
          sm:my-0 my-4 min-w-[150px]">
            <h4 className="font-poppins font-medium font-normal
            text-[18px] text-white leading-[27px] ">
              {footerLink.title}
              </h4>
